...
public class UsuarioController {
	...
	@GetMapping
	@Operation(summary = "Busca dados de Usuários por Email", description = "Busca dados do do usuário")
	...
	@DeleteMapping("/{email}")
	@Operation(summary = "Deleta Usuários por E-mail", description = "Deleta usuário")
